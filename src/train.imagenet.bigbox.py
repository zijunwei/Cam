...
tst_dir = 'ILSVRC2012_img_test'

image_dir_list = label_names = filter(lambda x: x.startswith('n'), os.listdir(os.path.join(dataset_path,tr_dir)))
...
image_paths_train = np.hstack(map(lambda one_class: one_class[:], image_paths_per_label))
